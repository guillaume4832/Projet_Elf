...
clean:
	rm -f main elfheader.o elfsection.o elfsectionheader.o elfsymtable.o filereader.o elfrelocation.o elfdeleterel.o elfrecolateSymb.o elfmodifsymb.o elfrelocateSymb.o *.gch *~ ARM_*
