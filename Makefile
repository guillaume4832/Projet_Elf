main: main.c elfheader.o elfsectionheader.o elfsection.o elfsymtable.o filereader.o
	gcc -o main main.c elfheader.o elfsectionheader.o elfsection.o elfsymtable.o filereader.o
...
clean:
	rm -f main elfheader.o elfsection.o elfsectionheader.o elfsymtable.o filereader.o
